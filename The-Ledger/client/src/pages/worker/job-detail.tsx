  ...
  return (
    <WorkerMobileLayout title="Job Details">
      ...
      <div className="bg-white border-b px-4 py-2 flex items-center gap-3 sticky top-0 z-30 shadow-sm">
        <button onClick={() => setLocation("/worker/jobs")} aria-label="Back to my jobs" className="p-2 -ml-2 text-slate-500 hover:text-slate-900 rounded-full hover:bg-slate-100">
