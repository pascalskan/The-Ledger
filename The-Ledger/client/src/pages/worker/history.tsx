      ...
      <div className="p-4 space-y-5" data-testid="worker-history">
        ...
        <section data-testid={showingShifts ? "worker-shift-history" : "worker-history-list"}>
          {filtered.length === 0 ? (
            ...
            >
              <div className="w-12 h-12 mx-auto bg-slate-50 text-slate-400 rounded-full flex items-center justify-center mb-3">
              ...
              {filtered.map((e) => {
                ...
                return (
                  ...
                  >
                    ...
                    {(e.hours ?? 0) > 0 && (
                      <div className="mt-3 flex items-center gap-4 rounded-xl bg-slate-50 px-3 py-2 text-xs">
